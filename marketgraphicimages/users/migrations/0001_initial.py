    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(upload_to='user_photos', verbose_name='Profile photo')),
                ...
                ('telegram_link', models.URLField(blank=True, verbose_name='Telegram profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email', models.EmailField(error_messages={'unique': 'User with such an email already exists'}, help_text='Enter the email.', max_length=320, unique=True, validators=[django.contrib.auth.validators.ASCIIUsernameValidator()], verbose_name='Email')),
                ('confirmation_code', models.CharField(max_length=100, verbose_name='Confirmation code')),
            ],
        ),
        migrations.CreateModel(
